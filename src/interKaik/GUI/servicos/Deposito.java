...
public Deposito(ContaDoCliente conta, ContasGerais sistema) {
this.conta = conta;
...
btnSair.addActionListener(new ActionListener() {
 ...
 botao100.setBounds(22, 37, 170, 69);
 ...
 botao200.setBounds(22, 184, 170, 69);
 ...
 botao300.setBounds(22, 351, 170, 69);
 ...
 botao400.setBounds(687, 37, 170, 69);
 ...
 botao500.setBounds(687, 184, 170, 69);
 ...
 outros.setBounds(687, 351, 170, 69);
 panel_2.add(outros);
 
 JPanel panel_4 = new JPanel();
 panel_4.setBackground(Color.LIGHT_GRAY);
 panel_4.setBounds(220, 37, 432, 383);
 panel_2.add(panel_4);
 ...
 JLabel lblTelaDeposito = new JLabel("DEPOSITO");
 lblTelaDeposito.setBounds(220, 23, 232, 14);
 panel_2.add(lblTelaDeposito);
 lblTelaDeposito.setFont(new Font("Dialog", Font.BOLD, 16));
 lblTelaDeposito.setHorizontalAlignment(SwingConstants.LEFT);
 
 JPanel foto = new JPanel();
 foto.setBounds(962, 131, 222, 413);
 panel.add(foto);
 
 ImageIcon imgPanel3Original = new ImageIcon(getClass().getResource("/interKaik/GUI/img/deposito.jpg"));
